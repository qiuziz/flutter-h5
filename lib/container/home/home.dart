...
class WebViewDemoPage extends StatefulWidget {
  WebViewDemoPage({Key key, this.url}) : super(key: key);
...
class _WebViewExampleState extends State<WebViewDemoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          NavigationControls(_controller.future, left: false, right: true, replay: true,),
        ...
        return SafeArea(
          ...
          child: WebView (
              ...
              navigationDelegate: (NavigationRequest request) {
                ...
                //           builder: (context) =>
                //               new WebViewDemoPage(url: request.url)));
                //   return NavigationDecision.prevent;
                // }
        ...
        onMessageReceived: (JavascriptMessage result) {
          ...
          if (res['method'] == 'PUSH') {
            Navigator.push(
              ...
              new MaterialPageRoute(
                    builder: (context) =>
                      new WebViewDemoPage(url: res['url'])
                  )
            );
          }
          if (res['method'] == 'POP') {
                          ...
                          new FlatButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  new MaterialPageRoute(
                                      builder: (context) => new WebViewDemoPage(
...
class NavigationControls extends StatelessWidget {
  const NavigationControls(this._webViewControllerFuture, { this.left: false, this.right: false, this.replay: false } )
